...
.add_n("User", Some(props! { "age" => data.in_age.clone(), "r_status" => data.in_r_status.clone(), "user_num" => data.in_user_num.clone(), "interests" => data.in_interests.clone(), "gender" => data.in_gender.clone(), "numoffriends" => data.in_numoffriends.clone() }), Some(&["user_num"])).collect_to::<Vec<_>>();
