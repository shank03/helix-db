...
pub struct NodeUnusedWithTrailingComma {
    pub name: String,
    pub is_admin: bool,
}

pub struct NodeUnusedWithNoTrailingComma {
    pub name: String,
    pub is_admin: bool,
}

pub struct EdgeUnusedWithNoProps {
    pub from: NodeUnusedWithTrailingComma,
    pub to: NodeUnusedWithTrailingComma,
}

pub struct EdgeUnusedWithoutPropsOrTrailingComma {
    pub from: NodeUnusedWithTrailingComma,
    pub to: NodeUnusedWithTrailingComma,
}

pub struct EdgeUnusedWithPropsAndTrailingComma {
    pub from: NodeUnusedWithTrailingComma,
    pub to: NodeUnusedWithTrailingComma,
    pub prop1: String,
    pub prop2: String,
...
pub struct EdgeUnusedWithPropsAndNoTrailingComma {
    pub from: NodeUnusedWithTrailingComma,
    pub to: NodeUnusedWithTrailingComma,
    pub prop1: String,
}
